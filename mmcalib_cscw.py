...
class Paper:
    ...
    def __init__(self, paper_record):
        ...
        # Outcome
        self.outcomes_org = self.parsed_items(paper_record['outcome']) # Using udpated outcome entries from Zoe data
...
class LiteratureDataset:
    ...
    def __init__(self, data_metric_file_path, paper_details_file_path, paper_meta_file_path):
        ...
        """
        # year is added to data-metric sheet
        try:
            self.update_year()
            ...
            for rel in rels:
                ...
                if check == 6:
                    ...
                    edge_label = '{}:{}-{}'.format(paper.paper_id,
                                                   source, target)
                    if source == 'group composition' and target == 'process':
                        print('Found:',paper.print_paper_record())
    ...
    def update_setting_task_sample_experimental(self):
        ...
        """
        context_org = pd.read_csv(self.paper_details_file_path,sep=';')
    ...
    def get_papers_between_interval(self, start_year, end_year):
        ...
        for paper_id, paper in self.paper_store.items():
            #print('year:',paper.pub_year,' id:',paper_id)
    ...
    def populate_dataset(self):
        ...
        """
        df = pd.read_csv(self.data_metric_file_path,sep=';')
    ...
    def plot_trends(self,attribute,skip_values,fig_title):
        """
        ...
        skip_values : list
            list containing values to skip
        ...
        markers = ['o','D','v','^','*','p','s','h','x','d','1','2','3','4','5'][:len(attr_uniques)]
        ...
        for pid,paper in papers.items():
            ...
            for used_data in set(list(attr_vals.values())):
